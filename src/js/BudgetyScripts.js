...
var saveButtonField = document.getElementById("saveButton");

var logOffButtonField = document.getElementById("logoutButton");
...
saveButtonField.addEventListener("click", function () {
  ExportFunctions.saveTable();
});

logOffButtonField.addEventListener("click", function(){
  console.log("log off button clicked!");
